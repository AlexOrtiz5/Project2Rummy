...
public class Hand implements HandInterface {
   ...
   */
   ...
   /**
    * Removes the card at the specified Object from the hand.
    * @param Object poisition of the card to be removed.
    * @return the card removed from the hand, or the null reference if
    * the Object is not found.
    */
   public Card removeCard( Object ObjCard ) {
   ...
   */
   ...
   /**
    * The List Array of the hand of the player.
    * @return a list of the current hand of the player.
    */
   public Card[] getArray() {
	   int SizeOfHand = getNumberOfCards();
	   Card[] TmpArray = new Card[SizeOfHand];
	   for (int i = 0; i < SizeOfHand;i++) {
		   TmpArray[i] = hand.get(i);
	   }
	   return TmpArray;
   }
